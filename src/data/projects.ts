...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: 'Healthcare · Enterprise SaaS · Clinician tools',
    description: 'A shift-based clinical command centre for outpatient clinicians. Instead of opening on appointment volumes, CareSync opens on what needs attention before the next patient walks in. Eight connected screens, a custom aubergine design system, and safety-led colour semantics.',
    tags: ['UX/UI Design', 'Healthcare', 'Enterprise SaaS', 'Product Strategy', 'Design System', 'Accessibility', 'React Prototype', 'AI-assisted Workflow'],
    status: 'complete',
    featured: false,
    href: '/projects/caresync',
    ...
    image: '/images/projects/caresync/cover.png',
