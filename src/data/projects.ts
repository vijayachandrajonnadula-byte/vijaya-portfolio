...
export const projects: Project[] = [
  {
    ...
    description: 'A healthcare booking case study exploring how patients find doctors, compare availability, book appointments, and manage visits through a clearer product flow.',
    ...
    image: '/images/projects/riverside/ui-screens/hi-home.png',
    category: 'Healthcare',
    year: '2026',
